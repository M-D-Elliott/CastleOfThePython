...
def initialize():
    ...
    db.connect()
    db.create_tables([MonsterDB], safe=True)
...
for monster in all_monsters:
    MonsterDB.create(name=monster[0], type=monster[1], spells=monster[2], min_hp=monster[3], max_hp=monster[4],
